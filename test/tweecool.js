	...
	$.fn.extend({
		...
		tweecool : function(options) {
			...
			return this.each(function() {
				var o = options;
				var wrapper = $(this);
				var wInner = $('<div class="transaction-list">').appendTo(wrapper);
				...
				$.getJSON("https://www.api.tweecool.com/?screenname=" + o.username + "&count=" + o.limit, function(data) {
					...
					$.each(data.tweets, function(i, field) {
						...
						wInner.append('<div><div class="tweets_txt">' + field.text.replace(urlpattern, '<a href="$1" target="_blank">$1</a>') + media + ' <span>' + timestamp + '</span></div></div>');
					});
